...
<body>
            ...
            <div class="row merged">
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <div class="land-featurearea">
                        <div class="land-meta">
                            <span><img src="images/logo_blue.png" alt=""></span>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        ...
                        <div class="log-reg-area sign">
                            ...
                            <form method="post" action="{{ route('login') }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input style="color:#080808;" type="text" name="email" id="input" required="required" au>
                                    <label class="control-label @error('email') is-invalid @enderror" for="input">Username
                                        @error('email')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                        @enderror </label><i class="mtrl-select"></i>

                                </div>
                                <div class="form-group">
                                    <input style="color:#080808;" name="password" type="password" required="required">
                                    <label class="control-label @error('password') is-invalid @enderror" name="password" for="input">Password</label><i class="mtrl-select"></i>
                                    @error('password')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <a class="btn btn-success" style="margin: 2px;" href="/login/github">Login or Register With Github</a>
                            <a class="btn btn-info" style="margin: 2px;" href="/login/facebook">Login or Register With Facebook</a>
                            <a class="btn btn-primary" style="margin: 2px;" href="/login/google">Login or Register With Google</a>
                        ...
                        <div class="log-reg-area reg">
                            ...
                            <form method="POST" action="{{ route('register') }}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-12">
                                        <input style="color:#080808;" id="name" placeholder="Name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" required>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-12">
                                        <input style="color:#080808;" id="name" placeholder="Username" type="text" class="form-control @error('username') is-invalid @enderror" name="username" value="{{ old('username') }}" required>
                                ...
                                <div class="form-group row">
                                    <div class="col-md-12">
                                        <input style="color:#080808;" id="email" placeholder="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-12">
                                        <input style="color:#080808;" placeholder="password" id="password" type="password" class="form-control @error('password') is-invalid @enderror" name="password" required autocomplete="new-password">
                                ...
                                <div class="submit-btns">
                                    <button style="width: 100px; height:40px;" type="submit">Register</button>
                                </div>
    ...
    <div id="topcontrol" title="Scroll Back to Top" style="position: fixed; bottom: 10px; right: 5px; opacity: 0; cursor: pointer;"><i class="fa fa-angle-up"></i>
    </div>
</body>
