...
<div class="central-meta">
        <div class="editing-info">
            <h5 class="f-title"><i class="ti-info-alt"></i> Edit Personal Information</h5>
            <form method="POST" action="{{route('settings.profile')}}" enctype="multipart/form-data">
                ...
                <input value="{{Auth::user()->image}}" name="image_old" type="hidden">
                <input value="{{Auth::user()->timeline_image}}" name="timeline_image_old" type="hidden">
                <div class="form-group">
                    <input name="name" type="text" value="{{Auth::user()->name}}" required="required">
                    <label class="control-label" for="input">Name</label><i class="mtrl-select"></i>
                </div>
                <div class="form-group">
                    <input name="email" type="email" value="{{Auth::user()->email}}" required="required">
                ...
                <div class="form-group">
                    <label>Timeline Picture</label>
                    <input name="timeline_image" type="file">
                </div>
    ...
    <div class="central-meta">
        <div class="editing-info">
            ...
            <form method="post" action="{{route('settings.update')}}">
                ...
                <div class="form-group">
                    <input type="text" name="city" value="@if(Auth::user()->profile){{Auth::user()->profile->city}} @else city @endif" required="required">
                ...
                <div class="form-group">
                    <textarea name="information" rows="4" id="textarea" required="required">@if(Auth::user()->profile){{Auth::user()->profile->information}} @else @endif</textarea>
